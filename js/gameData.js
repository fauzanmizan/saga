...
// == PERIHAL: Refactoring GameData.js - Pemindahan FACTIONS_DATA dari gameData.js ke npcs.js ==
// - File ini kini mengimpor dan mengekspor kembali data dari modul-modul data spesifik.
// - Data yang belum direfaktor (REGIONS_DATA, JOURNAL_ENTRY_TEMPLATES) tetap berada di sini untuk sementara.
// - FACTIONS_DATA telah dipindahkan sepenuhnya ke js/data/npcs.js.
// ===========================================
// == MODIFIED BY: Tim 3.D ==
...
export * from './data/npcs.js'; // Sekarang FACTIONS_DATA akan diekspor dari sini
...
// HAPUS deklarasi FACTIONS_DATA dari sini, karena sudah dipindahkan ke npcs.js
// export const FACTIONS_DATA = { /* ... data FACTIONS_DATA asli ... */ }; // BARIS INI HARUS DIHAPUS

// REGIONS_DATA dan JOURNAL_ENTRY_TEMPLATES akan tetap di gameData.js untuk saat ini
// seperti yang diinstruksikan pada pemindahan sebelumnya (kecuali ada instruksi lebih lanjut untuk memindahkannya ke world.js)
